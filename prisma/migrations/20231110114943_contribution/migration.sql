...
INSERT INTO "new_Metering" ("checkId", "createdAt", "id", "intake", "isCommon", "isNoValue", "num", "payment", "userId", "value") SELECT "checkId", "createdAt", "id", "intake", "isCommon", "isNoValue", "num", "payment", "userId", "value" FROM "Metering";
DROP TABLE "Metering";
